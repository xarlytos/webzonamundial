    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {step === 2 && (
        <>
          ...
          <div className="space-y-3 max-h-[320px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-[#1E293B] scrollbar-track-transparent">
            ...
            >
              <input
                ...
                className="sr-only"
              />
              <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 border-2 border-[#1E293B] flex items-center justify-center bg-[#0B1825]"
                style={{ 
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-bold text-white">No elegir ninguno</div>
                <div className="text-xs text-gray-500">Podrás elegir tu creador favorito más tarde</div>
              </div>
              {formData.creador === '' && (
            ...
            {creadores.map((c) => (
              ...
              >
                <input
                  ...
                  className="sr-only"
                />
                <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 border-2 transition-all"
                  style={{ 
