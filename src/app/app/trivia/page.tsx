...
const GAME_MODES = [
  { icon: "🌅", title: "Daily Trivia", desc: "10 preguntas nuevas cada día, mantén tu racha y acumula puntos semanales", highlight: "Racha diaria" },
  { icon: "⚡", title: "Speed Round", desc: "60 segundos, responde máximas preguntas posibles, bonus ×2 si respondes en <3 segundos", highlight: "Bonus velocidad" },
  { icon: "🏆", title: "Battle Royale", desc: "100 jugadores, 1 ganador, rondas eliminatorias cada 10 preguntas", highlight: "100 vs 1" },
  { icon: "☠️", title: "Death Match", desc: "Sin límite de preguntas, falla una = ELIMINADO, récord actual: 47 preguntas", highlight: "Sobrevive" },
  { icon: "🎯", title: "Pre-match Trivia", desc: "Trivia especial antes de cada partido importante del Mundial 2026", highlight: "Antes del partido" },
];
