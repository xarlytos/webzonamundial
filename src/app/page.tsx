  ...
  return(
    <div style={{background:BG,color:"#fff",fontFamily:"'Outfit',sans-serif",minHeight:"100vh"}} className="relative overflow-hidden">
      ...
      <div className="w-full border-y border-white/5 py-8 sm:py-12 relative" style={{background:"#07101C"}}>
        <p className="text-center text-[#C9A84C]/50 text-[11px] font-bold tracking-widest uppercase mb-6 select-none">Patrocinador Oficial</p>
        <div className="max-w-4xl mx-auto px-4">
          <div className="w-full h-32 sm:h-40 md:h-48 rounded-2xl border-2 border-dashed border-[#C9A84C]/30 bg-[#0B1825]/50 flex items-center justify-center hover:border-[#C9A84C]/60 hover:bg-[#0B1825] transition-all duration-300 cursor-pointer group">
            <div className="text-center">
              <span className="text-[#C9A84C]/40 text-lg sm:text-xl font-bold group-hover:text-[#C9A84C]/70 transition-colors">ESPACIO DISPONIBLE</span>
              <p className="text-[#C9A84C]/20 text-xs sm:text-sm mt-2">Tu marca aquí</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* ═══════ AD SPACE 2 — Espacio de Patrocinador ═══════ */}
      <div className="w-full border-y border-white/5 py-8 sm:py-12 relative" style={{background:"#07101C"}}>
        <p className="text-center text-[#C9A84C]/50 text-[11px] font-bold tracking-widest uppercase mb-6 select-none">Patrocinador Premium</p>
        <div className="max-w-4xl mx-auto px-4">
          <div className="w-full h-32 sm:h-40 md:h-48 rounded-2xl border-2 border-dashed border-[#C9A84C]/30 bg-[#0B1825]/50 flex items-center justify-center hover:border-[#C9A84C]/60 hover:bg-[#0B1825] transition-all duration-300 cursor-pointer group">
            <div className="text-center">
              <span className="text-[#C9A84C]/40 text-lg sm:text-xl font-bold group-hover:text-[#C9A84C]/70 transition-colors">ESPACIO PREMIUM</span>
              <p className="text-[#C9A84C]/20 text-xs sm:text-sm mt-2">Exclusivo para tu marca</p>
            </div>
          </div>
        </div>
      </div>
