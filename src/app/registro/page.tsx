      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#C9A84C]/30 text-xs font-bold text-[#C9A84C] tracking-wider uppercase mb-6"
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-12">
              {[
                { value: totalSeg, label: 'Seguidores', icon: '👥' },
                { value: numCreadores.toString(), label: 'Creadores', icon: '🌟' },
                { value: '104', label: 'Partidos', icon: '⚽' },
                { value: '8', label: 'Modos', icon: '🎮' },
              ].map((stat, i) => (
                <div key={i} className="flex items-center gap-3 px-5 py-3 rounded-2xl border border-[#1E293B]/50"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 sm:p-8 rounded-3xl border border-[#1E293B]/50"
                ...
                <div className="space-y-3">
                  {creadores.slice(0, 4).map((c, i) => (
                    <Link key={c.slug} href={`/registro/${c.slug}`}
                      className="flex items-center gap-4 p-4 rounded-2xl border border-[#1E293B]/30 hover:border-[#C9A84C]/30 transition-all duration-300 group"
                ...
                <Link href="/creadores" 
                  className="block text-center mt-4 text-sm text-[#C9A84C] hover:underline">
