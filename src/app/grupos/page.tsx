      ...
      <div className="p-5">
        ...
        <div ref={teamsRef} className="space-y-2.5">
          {selecciones.map((team, idx) => (
            <div key={team.slug} className="team-item flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-colors">
              <img 
    ...
    <div style={{ background: BG, minHeight: '100vh' }}>
      ...
      <section ref={heroRef} className="relative overflow-hidden" style={{ padding: '80px 20px 60px' }}>
        ...
        <div className="max-w-6xl mx-auto relative">
          {/* Breadcrumb */}
          <nav ref={breadcrumbRef} className="flex items-center gap-2 text-sm text-[#6a7a9a] mb-6" style={{ opacity: 0 }}>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 ref={titleRef} className="text-4xl md:text-6xl font-black text-white mb-4 leading-tight" style={{ opacity: 0 }}>
              Los <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#c9a84c] to-[#e8d48b]">12</span> Grupos
            </h1>
            <p ref={subtitleRef} className="text-lg text-[#8a94b0] mb-8" style={{ opacity: 0 }}>
            ...
            <div ref={statsRef} className="flex flex-wrap justify-center gap-4">
              {[
                ...
                <div key={stat.label} className="stat-item flex items-center gap-3 px-4 py-2 bg-[#0F1D32] rounded-xl border border-white/5" style={{ opacity: 0 }}>
      ...
      <section className="max-w-6xl mx-auto px-4 mb-16">
        <div ref={sectionTitleRef} className="flex items-center gap-4 mb-8" style={{ opacity: 0 }}>
      ...
      <section ref={formatRef} className="max-w-6xl mx-auto px-4 mb-16" style={{ opacity: 0 }}>
